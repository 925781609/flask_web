from flask import render_template, flash, redirect, url_for, request, send_from_directory, current_app, make_response
from . import main
from ..decorators import admin_required, permission_required
from ..models import Permission, User, Role, Post, Follow, Comment
...
def post(id):
    ...
    if form.validate_on_submit():
        ...
        #print('current_user.__get_current_object:' + current_user._get_current_object())
        print('Before add comment to mysql')
        db.session.add(comment)
        print('After add comment to mysql')
